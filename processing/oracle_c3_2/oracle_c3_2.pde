...
void setup() {
  ...
  water2Mov = new Movie(this, "water copy.mov");
  thunderMov = new Movie(this, "thunder.mov");
  thunder2Mov = new Movie(this, "thunder copy.mov");
  earthMov = new Movie(this, "earth.mov");
  earth2Mov = new Movie(this, "earth copy.mov");
  mountainMov = new Movie(this, "mountain.mov");
  mountain2Mov = new Movie(this, "mountain copy.mov");
  heavenMov = new Movie(this, "heaven.mov");
  heaven2Mov = new Movie(this, "heaven copy.mov");
  windMov = new Movie(this, "wind.mov");
  wind2Mov = new Movie(this, "wind copy.mov");
  fireMov = new Movie(this, "fire.mov");
  fire2Mov = new Movie(this, "fire copy.mov");
  lakeMov = new Movie(this, "lake.mov");
  lake2Mov = new Movie(this, "lake copy.mov");
